...
- **NuGet package**: `Cr1140.Avalonia` (PackageId), version `0.11.0`. Package README is this file (`PackageReadmeFile`); license is `GPL-3.0-only` (dual-licensed GPL-3.0-only OR commercial, same as the workspace).
