#!/bin/sh
# Reversibly install the Avalonia demo (replace CODESYS + disable the Rust demo).
...
APPDIR=/home/cds-apps/cr1140-avalonia-demo
...
# restore.sh unmasks it. See ADR-0002.
...
# Also stop and mask the Rust demo autostart so the two apps never fight for /dev/fb0.
echo "Stopping + masking cr1140-app.service (the Rust demo) ..."
